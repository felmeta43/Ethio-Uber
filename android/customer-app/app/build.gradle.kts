...
android {
    namespace = "com.ethiouber.customer"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.ethiouber.customer"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
        ...
        buildConfigField("String", "WS_BASE_URL", "\"ws://10.0.2.2:8000/ws/tracking/\"")
    ...
    buildTypes {
        release {
            ...
            buildConfigField("String", "WS_BASE_URL", "\"wss://api.ethiouber.com/ws/tracking/\"")
        }
        debug {
            isDebuggable = true
